  ...
  return <div className={cls.container}>
   ...
   { isProfileForm
    ...
    <div className={ toggle ? cls.links : cls.links + ' ' + cls.hidden }>
      <Link className={ cls.link } to={''} onClick={ onToggle } >Изменить данные</Link>
      <Link className={ cls.link } to={''} onClick={ toggleForm } >Изменить пароль</Link>
      <Link className={ cls.link } to={'/'}>Выйти</Link>
    </div>
